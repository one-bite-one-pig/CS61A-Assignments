...
def play(strategy0, strategy1, update,
    ...
    while score0<goal and score1<goal:
        if who==0:
            s1=strategy0(score0,score1)
            score0=update(s1,score0,score1,dice)
        else:
            s2=strategy1(score1,score0)
            score1=update(s2,score1,score0,dice)
        who=1-who
    # END PROBLEM 5
...
def is_always_roll(strategy, goal=GOAL):
    ...
    t=strategy(0,0)
    sign=1
    for i in range(0,goal+1,1):
        for j in range(0,goal+1,1):
            if t!=strategy(i,j):
                sign=0
    if sign==1:
        return True
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    if sus_points(boar_brawl(score,opponent_score)+score)-score>=threshold:
        return 0
    else:
        return num_rolls
